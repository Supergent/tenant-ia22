  ...
  theme: {
    extend: {
      ...
      fontFamily: {
        ...
        heading: theme.typography.headingsFamily.split(", "),
      },
      fontSize: {
        ...
        lg: [`${theme.typography.scale.lg}px`, { lineHeight: "1.4" }],
        xl: [`${theme.typography.scale.xl}px`, { lineHeight: "1.3" }],
        "2xl": [`${theme.typography.scale["2xl"]}px`, { lineHeight: "1.2" }],
      },
      fontWeight: {
        regular: String(theme.typography.weight.regular),
